    ...
    return (
        <header>
            ...
            <div className="theme-switch">
                ...
                >
                    <span>{isDarkTheme ? (<svg data-testid="geist-icon" height="16" stroke-linejoin="round" viewBox="0 0 16 16" width="16" style={{ width: '16px;', height: '16px;', color: '#000;' }}><path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    ></path></svg>) : <svg data-testid="geist-icon"
